...
% folderPath = 'ComputedScalarsPaper';
% if isfolder(folderPath)
%     rmdir(folderPath, 's');  % Remove the directory and its contents only if it exists
% else
%     disp(['Directory does not exist, skipping removal: ', folderPath]);
% end
